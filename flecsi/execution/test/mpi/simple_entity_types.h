...
struct simple_vertex_t : public flecsi::topology::mesh_entity_t<0, 1>
{
  ...
  simple_vertex_t(flecsi::topology::mesh_topology_base_t& mesh,
                  const point_t& coords) : _mesh(mesh), _coords(_coords) {}
...
{
  simple_cell_t(flecsi::topology::mesh_topology_base_t& mesh, size_t _type) : type(_type){}
