...
///
// \struct mpi_execution_policy mpi_execution_policy.h
// \brief mpi_execution_policy provides...
///
struct mpi_execution_policy_t
{
  template<typename R>
  using future__ = mpi_future__<R>;
